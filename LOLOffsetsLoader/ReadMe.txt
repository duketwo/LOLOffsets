========================================================================
    KONSOLENANWENDUNG: LOLOffsetsLoader-Projektübersicht
========================================================================

Diese LOLOffsetsLoader-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LOLOffsetsLoader-Anwendung besteht.


LOLOffsetsLoader.vcxproj
...
LOLOffsetsLoader.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LOLOffsetsLoader.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
