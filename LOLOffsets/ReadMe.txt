========================================================================
    DYNAMIC LINK LIBRARY: LOLOffsets-Projektübersicht
========================================================================

Diese LOLOffsets-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre LOLOffsets-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen LOLOffsets.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
